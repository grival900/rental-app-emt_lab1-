...
import com.example.rentalapp.config.CustomUsernamePasswordAuthenticationProvider;
...
public class JwtSecurityWebConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                // disable CSRF (we’re stateless JWT or REST)
                ...
                .authorizeHttpRequests(auth -> auth
                        // public endpoints
                                .requestMatchers(
                                        "/swagger-ui/**",
                                        "/v3/api-docs/**"
                                ).permitAll()   // documentation is public
